...
theme.font      = "profont 10" -- "Droid Sans Mono 11"
...
theme.layout_tile       = theme.confdir .. "/layouts-huge/tile-blue.png"
theme.layout_tileleft   = theme.confdir .. "/layouts-huge/tileleft-red.png"
theme.layout_tilebottom = theme.confdir .. "/layouts-huge/tilebottom-green.png"
theme.layout_tiletop    = theme.confdir .. "/layouts-huge/tiletop-blue.png"
theme.layout_fairv      = theme.confdir .. "/layouts-huge/fairv-red.png"
theme.layout_fairh      = theme.confdir .. "/layouts-huge/fairh-green.png"
theme.layout_spiral     = theme.confdir .. "/layouts-huge/spiral-blue.png"
theme.layout_dwindle    = theme.confdir .. "/layouts-huge/dwindle-red.png"
theme.layout_max        = theme.confdir .. "/layouts-huge/max-green.png"
theme.layout_fullscreen = theme.confdir .. "/layouts-huge/fullscreen-blue.png"
theme.layout_magnifier  = theme.confdir .. "/layouts-huge/magnifier-red.png"
theme.layout_floating   = theme.confdir .. "/layouts-huge/floating-green.png"
